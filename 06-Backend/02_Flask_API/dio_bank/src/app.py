...
class Post(db.Model):
    ...
    create_app: Mapped[str] = mapped_column(sa.DateTime, server_default=sa.func.now())
    author_id: Mapped[str] = mapped_column(sa.String, sa.ForeignKey("user.id"), nullable=False)
